    ...
    return (
        <div>
            ...
            <div className='text-[#712941] text-center p-4 sm:p-6 uppercase mt-2'>
                <p className='text-center text-[#712941] text-xl sm:text-2xl md:text-[35px] font-bold'>Class Details</p>
            </div>
            <hr />

         
            <div className="flex flex-col md:flex-row items-start justify-between p-4 sm:p-8 md:p-12 gap-6 md:gap-10">
                
              
                <div className='w-full md:flex-[50%]'>
                    <img
                        src={clss.image}
                ...
                <div className="flex flex-col w-full md:w-auto">
                    <img
                        ...
                        className="w-full md:w-80 h-48 sm:h-56 object-cover rounded-md object-[center_20%]"
                    />
            ...
            <div className='flex flex-col px-4 sm:px-8 md:px-12 text-[#712941] mt-0 md:mt-[-50px]'>

                
                <p className='text-2xl sm:text-3xl md:text-[35px]'>{clss.name}</p>
                <div className='flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-12 mt-2'>
                    <div className='flex items-center gap-2'>
                    ...
                    <div className='flex gap-2 text-sm sm:text-base'>
                        <p>Submitted Date</p>
                        <p className='text-[#c86989]'>{clss.submitted && clss.submitted.split("T")[0]}</p>
                    </div>
                </div>
                ...
                <div className='mt-8 sm:mt-12'>
                    ...
                    <p className='w-full md:w-[50%] mt-2 text-sm sm:text-base leading-relaxed'>{clss.description}</p>
                </div>

                
                <div className="w-full md:max-w-4xl mt-8 sm:mt-12">
                    <p className="text-xl sm:text-2xl font-bold text-[#712941] mb-4 sm:mb-6">What you will learn</p>
