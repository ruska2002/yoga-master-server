...
const EmailSender = () => {
  ...
  return (
    <section className="w-full py-10 px-4 font-dancing">
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <button
            onClick={sendEmail}
            disabled={loading}
            className="w-full sm:w-auto whitespace-nowrap bg-[#712941] text-white px-6 py-3 rounded-lg hover:bg-[#c86989] active:scale-95 transition-all duration-150 disabled:opacity-50"
          >
